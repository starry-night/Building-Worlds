...
public class sad : MonoBehaviour {
	...
	public Transform sadBlueprint1;
	public Transform sadBlueprint2;
	...
	IEnumerator Generator1(){
		...
		Instantiate (sadBlueprint1, randomPosition1 (), Quaternion.Euler (0, Random.Range (0, 360), 0));
	...
	IEnumerator Generator2(){
		...
		while (counter2 < maxCopies2) {
			...
			Instantiate (sadBlueprint2, randomPosition2 (), Quaternion.Euler (0, Random.Range (0, 360), 0));
